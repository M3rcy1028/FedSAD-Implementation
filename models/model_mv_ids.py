...
def run(args):
    ...
    # 학습
    # ---------------------------
    model = train_loop(model, dl_train, None, args, save_path=args.result_path)
    ...
    torch.save(save_dict, args.result_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path',type=str, default="results/UNSW-NB15/mvids/mvids_weights.pt")
